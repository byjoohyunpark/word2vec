...
source_path = '../word_vector_pretrained_data/' + target+"/" +target+"_gensim_result.json"
output_path = '../word_vector_pretrained_data/' + target+"/" + target+ "_2d_vector_result.json"
...
# Parameters matters
tsne_model = TSNE(n_components=2, early_exaggeration=8.0, learning_rate=300.0, random_state=0)
